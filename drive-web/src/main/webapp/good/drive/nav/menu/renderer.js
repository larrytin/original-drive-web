goog.provide('good.drive.nav.menu.Renderer');
...
good.drive.nav.menu.Renderer = function() {
  goog.ui.ButtonRenderer.call(this);
};
goog.inherits(good.drive.nav.menu.Renderer, goog.ui.ButtonRenderer);
goog.addSingletonGetter(good.drive.nav.menu.Renderer);

good.drive.nav.menu.Renderer.CSS_CLASS = goog.getCssName('jfk-button');

good.drive.nav.menu.Renderer.prototype.createDom = function(control) {
...
good.drive.nav.menu.Renderer.prototype.getAriaRole = function() {
  return goog.a11y.aria.Role.BUTTON;
};

good.drive.nav.menu.Renderer.prototype.getContentElement = function(element) {
  return element && /** @type {Element} */ (element.firstChild.firstChild);
};

good.drive.nav.menu.Renderer.prototype.createButton = function(content, dom) {
...
good.drive.nav.menu.Renderer.prototype.canDecorate = function(element) {
  return element.tagName == 'DIV';
};

good.drive.nav.menu.Renderer.prototype.hasBoxStructure = function(
    button, element) {
...
good.drive.nav.menu.Renderer.prototype.decorate = function(control, element) {
  var button = /** @type {goog.ui.Button} */ (control);
  ...
  good.drive.nav.menu.Renderer.trimTextNodes_(element, true);
  good.drive.nav.menu.Renderer.trimTextNodes_(element, false);
  ...
  return good.drive.nav.menu.Renderer.superClass_.decorate.call(this, button,
      element);
};


good.drive.nav.menu.Renderer.prototype.getCssClass = function() {
  return good.drive.nav.menu.Renderer.CSS_CLASS;
};

good.drive.nav.menu.Renderer.trimTextNodes_ = function(element, fromStart) {
  if (element) {
